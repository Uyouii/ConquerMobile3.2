...
public class PiePolylineChartActivity extends DemoBase implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonday = (Button) findViewById(R.id.daybuttonchart);
        ...
        Button buttonweek = (Button) findViewById(R.id.weekbuttonchart);
        ...
        Button buttonmonth = (Button) findViewById(R.id.monthbuttonchart);
        ...
        Button buttonyear = (Button) findViewById(R.id.yearbuttonchart);
